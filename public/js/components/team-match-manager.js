    ...
    updateTeamRankings(rankings) {
        ...
        tbody.innerHTML = rankings.map(team => {
            ...
            return `<tr style="background-color: ${teamColorFaint}">
                        <td class="team-color" style="color: ${team.color};background-color: ${teamColorFaint}">${this.lang === "zh" ? team.name : team.engName}</td>
                        <td>${team.progress}</td>
    ...
    updatePlayerRankings(rankings) {
        ...
        tbody.innerHTML = this.sortPlayerRankings(rankings).map(player => {
            ...
            return `<tr style="background-color: ${teamColorFaint}">
                        ...
                        <td>${this.safeDividePct(stats.call + stats.riichi, stats.rounds)}</td>
        ...
        const sorted = rankings.sort((a, b) => {
            ...
            switch (this.currentPlayerRankingsSort.field) {
                ...
                case 'riichiRate':
                    ...
                    break;
                case 'actRate':
                    aValue = this.safeDivide(a.stats.call + a.stats.riichi, a.stats.rounds);
                    bValue = this.safeDivide(b.stats.call + b.stats.riichi, b.stats.rounds);
                    break;
                case 'riichiWinRate':
